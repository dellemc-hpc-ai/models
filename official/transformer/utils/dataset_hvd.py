...
def _read_and_batch_from_files(
    file_pattern, batch_size, max_length, num_parallel_calls, input_flag, shuffle, repeat,
    static_batch=False):
...
def train_input_fn(params):
  ...
  # added input_flag to differentiate train and eval
  ...
  return _read_and_batch_from_files(
      ...
      params["num_parallel_calls"], input_flag="train", shuffle=True,
...
def eval_input_fn(params):
  ...
  return _read_and_batch_from_files(
      file_pattern, params["batch_size"], params["max_length"],
      params["num_parallel_calls"], input_flag="eval", shuffle=False, repeat=1,
